        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li><strong>Your Uploads:</strong> You retain ownership of content you upload</li>
                <li><strong>AI-Generated Content:</strong> You own the AI-generated outputs from your inputs</li>
                <li><strong>Watermarks:</strong> All generated images include a &quot;toolkitai.io&quot; watermark</li>
                <li><strong>Your Responsibility:</strong> Ensure you have rights to all content you upload</li>
              </ul>
            </section>
